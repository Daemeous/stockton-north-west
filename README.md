# Stockton North & Stockton West — Leafletting Map

A canvassing and leafletting tracker for the combined branch area of Stockton North and Stockton West (Westminster constituencies), covering all 25 Stockton-on-Tees Council wards that fall in either seat. Volunteers can view road-level status, plan routes, and mark progress in real time via a Google Sheets backend.
...
Live: **https://daemeous.github.io/stockton-north-west/**
...
| OS Open Roads | [Open Government Licence v3.0](https://www.nationalarchives.gov.uk/doc/open-government-licence/version/3/) | © Crown copyright and database right, Ordnance Survey. Road geometry/name source for this deployment. Permits commercial use; requires attribution. |
...
| [OpenStreetMap](https://www.openstreetmap.org/copyright) | [ODbL](https://opendatacommons.org/licenses/odbl/) | Map tiles © OpenStreetMap contributors. Permits commercial use; requires attribution and share-alike for derivative databases. |
